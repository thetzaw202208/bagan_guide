...
import 'package:bagan/screens/foods/foods_details_screen.dart';
...
class _FoodsScreenState extends State<FoodsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<SouvenirData> souvenirList = [
      SouvenirData(
        LocaleKeys.zeeyeik.tr(),
        LocaleKeys.zeeyeikDescription.tr(),

        ['assets/images/foods/zeeyeik.png', 'assets/images/foods/zeeyeik1.png', 'assets/images/foods/zeeyeik2.png', 'assets/images/foods/zeeyeik3.png'],
              ...
              itemBuilder: (context,index)=>
                  Padding(
                    ...
                    child: GestureDetector(
                      onTap: (){
                        context.navigateAndRemoveUntil(FoodDetailsScreen(souvenirData: souvenirList[index]), true);
                      },
                      child: Material(
                          elevation: 3,
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image:  DecorationImage(
                                            image: AssetImage(souvenirList[index].images[0]),
                                            fit: BoxFit.cover
                                        )
                                    ),
                                  ),
